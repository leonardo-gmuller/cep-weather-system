...
type App struct {
	Name                    string        `required:"true" envconfig:"SERVICE_B_NAME"`
	ID                      string        `required:"true" envconfig:"SERVICE_B_ID"`
	GracefulShutdownTimeout time.Duration `required:"true" envconfig:"SERVICE_B_GRACEFUL_SHUTDOWN_TIMEOUT"`
}

type Server struct {
	Address      string        `required:"true" envconfig:"SERVER_B_ADDRESS"`
...
type Otel struct {
	...
	ServiceName      string  `required:"true" envconfig:"OTEL_SERVICE_B_NAME"`
