...
import (
	...
	"github.com/leonardo-gmuller/cep-weather-system/service-a/internal/app/gateway/api/handler"
	"github.com/leonardo-gmuller/cep-weather-system/service-a/internal/app/gateway/api/middleware"
)
...
func (api *API) registerRoutes(router *chi.Mux) {
	...
	router.Route("/service-a/v1", func(r chi.Router) {
